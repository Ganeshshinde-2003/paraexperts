      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            Navigator.pushNamed(
              context,
              AppRoutes.bookingIdDetails,
              arguments: widget.appointments.id,
            );
          },
          child: Container(
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        "${_formatDate(widget.appointments.date)} - ${_formatTime(widget.appointments.startTime)}",
                        style: TextStyle(
                            color: tertiaryColor,
                            fontFamily: InterFontFamily.semiBold,
                            fontSize: 15.sp),
                      ),
                      widget.appointments.status == "scheduled"
                          ? Row(
                              children: [
                                Text(
                                  "Remind Me",
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ClipRRect(
                            ...
                            child: Image.network(
                              widget.appointments.userId?.profilePicture
                                          ?.isNotEmpty ==
                                      true
                                  ? widget.appointments.userId!.profilePicture
                                      .toString()
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            widget.appointments.userId?.name ?? "Loading...",
                            style: TextStyle(
                              fontFamily: InterFontFamily.semiBold,
                              fontSize: 14.sp,
                              color: tertiaryColor,
